...
public final class Constants {
    ...
    public static final String BROADCAST_ACTION = "com.hermes.hermes.BROADCAST";
    ...
    public static final String EXTENDED_DATA_STATUS = "com.hermes.hermes.STATUS";

    // Defines the key for the log "extra" in an Intent
    public static final String EXTENDED_STATUS_LOG = "com.hermes.hermes.LOG";
    
    // Defines the key for storing fullscreen state
    public static final String EXTENDED_FULLSCREEN =
            "com.hermes.hermes.EXTENDED_FULLSCREEN";
